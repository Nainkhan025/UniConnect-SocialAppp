<div class="card mb-4 shadow-sm rounded-4">
    <div class="card-body p-3 d-flex align-items-center">
        ...
        @if (Auth::user()->profile_photo)
            <img src="{{ asset('storage/profile_photos/' . Auth::user()->profile_photo) }}" class="rounded-circle me-3"
                width="55" height="55">
        @else
        ...
        <div class="flex-grow-1">
            <div class="form-control rounded-pill ps-3 py-2" data-bs-toggle="modal" data-bs-target="#createPostModal"
