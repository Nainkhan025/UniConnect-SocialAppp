...
<body>
    ...
    <div class="container-fluid mt-4 pt-4">
        <div class="row g-0">
            ...
            <!-- Left Sidebar -->
            <aside
                class="col-md-3 d-none d-md-block bg-light shadow-sm position-fixed start-0 top-0 vh-100 mt-5 pt-4 overflow-auto">
            ...
            <!-- Main Content -->
            <main class="col-md-6 bg-light py-3 main-content" style="margin-left: 25%; margin-right: 25%; ">
                <div class="p-3">
                    @yield('content')
                </div>
            </main>
            ...
            <!-- Right Sidebar -->
            <aside
                class="col-md-3 d-none d-md-block bg-light shadow-sm vh-100 right-sidebar  position-fixed end-0 top-0 vh-100 mt-5 pt-4 overflow-auto">
